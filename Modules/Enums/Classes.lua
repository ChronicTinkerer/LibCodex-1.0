...
-- v2 slots: 1:id, 2:label (Z85), 3:token (Z85), 4:primaryStat (Z85)

local LibCodex = LibStub("LibCodex-1.0")
local Classes = LibCodex.CollectionFactory.New("Classes", {
    keyField = "id",
...
function Classes:_DecodeV2Row(slots, schemaVersion, build)
    ...
    if type(slots[4]) == "string" then entry.primaryStat = decodeZ85String(slots[4]) end
